...
type CryptoArticle struct {
	...
	ArticleName string    `json:"article_name" gorm:"column:article_name;type:varchar(255) comment '文章名稱';not null"`
	Title       string    `json:"title" gorm:"column:title;type:varchar(127) comment '文章標題';not null"`
	Type        string    `json:"type" gorm:"column:type;type:varchar(127) comment '文章來源';not null"`
